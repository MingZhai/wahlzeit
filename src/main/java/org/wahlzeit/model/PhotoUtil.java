...
public class PhotoUtil {
	 ...
	 * @methodtype creation
	 */
	public static RiverPhoto createPhoto(String filename, PhotoId id, Image uploadedImage) throws Exception {
//		Photo result = PhotoFactory.getInstance().createPhoto(id);
		RiverPhoto result = RiverPhotoFactory.getInstance().createPhoto(id);
